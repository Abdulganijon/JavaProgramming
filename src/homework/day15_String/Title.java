...
Note: It is possible to have both beginning and ending titles, one of them, or none of them
        ...
        System.out.println("Please enter your name including title: Ex.. Mr Jordan Smith Jr");
        String name = input.nextLine().toLowerCase();



        boolean male = name.startsWith("mr") || name.startsWith("mister");
        boolean female = name.startsWith("ms") || name.startsWith("miss") || name.startsWith("madam");
        boolean dr = name.startsWith("dr");
        boolean endTitleSr = name.endsWith("sr");
        boolean endTitleJr = name.endsWith("jr");
        ...
        if (male) {
            ...
            System.out.println("Nice to meet you Ma'am");
